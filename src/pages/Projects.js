  ...
  const proyectos = [
    {
      ...
      link: 'https://github.com/usuario/ecommerce', // Replace with your GitHub username
    },
    {
      nombre: 'Blog Personal',
      descripcion: 'Un blog minimalista creado con React y Markdown.',
      link: 'https://github.com/usuario/blog-personal', // Replace with your GitHub username
    },
    {
      nombre: 'Gestor de Tareas',
      descripcion: 'Aplicación para gestionar tareas diarias.',
      link: 'https://github.com/usuario/todo-app', // Replace with your GitHub username
    },
  ];
